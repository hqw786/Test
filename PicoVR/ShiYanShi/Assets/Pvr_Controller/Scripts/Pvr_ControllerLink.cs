...
public class Pvr_ControllerLink
{
    ...
    public bool isAutoConnect = true; //默认自动寻找Controller并连接
    //#endif
    ...
    {        
        ...
        {              
            ...
            {  
                ...
                {
                    notPhone = false;
                    Pvr_UnitySDKAPI.System.UPvr_CallStaticMethod(javaHummingbirdClass, "startPico2Service", activity);
                }
            }
    ...
    public  bool StopUpgrade()
    {
        bool stop = false;
#if ANDROID_DEVICE
        Pvr_UnitySDKAPI.System.UPvr_CallStaticMethod<bool>(ref stop, javaHummingbirdClass, "stopUpgrade");
#endif
        return stop;
    }
