    ...
    { 
        ...
        if (ExtendedAPI)
        {
            ...
            if (HomeKey.state)
            {
                ...
                if(HomeKey.timecount >= 1.5  && !HomeKey.longPressedClock)
                {
            ...
            if (APPKey.state)
            {
                ...
                if (APPKey.timecount >= 1.5 && !APPKey.longPressedClock)
                {
            ...
            if (TouchPadKey.state)
            {
                ...
                if (TouchPadKey.timecount >= 1.5 && !TouchPadKey.longPressedClock)
                {
            ...
            if (VolumeUpKey.state)
            {
                ...
                if (VolumeUpKey.timecount >= 1.5 && !VolumeUpKey.longPressedClock)
                {
            ...
            if (VolumeDownKey.state)
            {
                ...
                if (VolumeDownKey.timecount >= 1.5 && !VolumeDownKey.longPressedClock)
                {
